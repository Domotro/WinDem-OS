# (FR)
Bonjour petit dévelopeur (je pense), tu va pouvoir tester WinDem OS V4.1 ! Mais avant tous, tu dois faire toutes ces étapes sinon tu ne pourra pas:
...
Hello, little developer (I think), you're about to be able to test WinDem OS V4.1! But first, you must complete all these steps, otherwise you won't be able to:
